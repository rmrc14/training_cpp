...
rules: 
1. when the size =cap, cap is doubled by earlier value => resizing the array
	a. when the array is resized we need to move the content from earlier mem to new mem
